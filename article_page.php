...
<html lang="en">
  ...
  <body>
      ...
      $r = "SELECT * FROM Article WHERE nom = '".htmlspecialchars($_GET['nom'])."'";
      $requete = $db->query($r);
		...
		<div class="card">
			<div class="container-fliud">
          	...
          	<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="Back-Office/uploads/items/'.$req["image"].'" />
						  </div>					  
						</div>
						</div>
					<div class="details col-md-6">
						<h3 class="product-title">'.$req["nom"].'</h3><br>
						<div class="rating">
							<span class="review-no" style="color: white; font-size: 20px;">52: vues</span>
							<span class="review-no" style="color: white; font-size: 20px; float: right;">Quantités : 20</span>
						</div>
						<br><br>
						<label class="product-description">Description :</label>
						<p class="product-description">aaaaaaaaaaa</label></p>
