...
<html lang="en">
 ...
 <main>
			<div class="container">
				<h2 style="text-align: center;">New informations</h2>
				<div class="col-md-12 col-sm-12" id="add_form">

          
					<form action="verif-add-information.php" method="post" enctype="multipart/form-data">

						<div class="mb-4">
							<div class="form-floating">
								<input class="form-control" type="text" name="titre" placeholder="">
								<label>Titre</label>
							</div>
						</div>
