...
<html lang="en">
 ...
 <main>
			<div class="container">
				<h2 style="text-align: center;">Nouvel trottinette</h2>
				<div class="col-md-12 col-sm-12" id="add_form">

          
					<form action="verif-add-trottinette.php" method="post" enctype="multipart/form-data">

						<div class="mb-4">
							<div class="form-floating">
								<input class="form-control" type="text" name="Nom_complet" placeholder="">
						...
						<div class="mb-4">
							<div class="form-floating">
								<input class="form-control" type="text" name="prix" placeholder="">
								<label>prix</label>
							</div>

							<div class="mb-4">
							<div class="form-floating">
								<input class="form-control" type="text" name="stock" placeholder="">
