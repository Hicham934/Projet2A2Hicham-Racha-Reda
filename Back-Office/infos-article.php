...
<html lang="en">
  ...
  <body>
  	...
  	include("../includes/db_connexion.php");
		...
		$s = 'SELECT id,nom,prix,promotion,image,add_date,add_admin,stripe
					FROM Article';
		$req_select = $db->query($s);
		$select = $req_select->fetchAll(PDO::FETCH_ASSOC);

		foreach ($select as $Article) {
			$date = date_create($Article["nom"]);
			echo '<tr>
						 <td scope="row">(' . $Article['id'] .')</td>
						 <td scope="row">' . $Article['nom'] .'</td>
						 <td scope="row">' . $Article['prix'] .'€</td>
						 <td scope="row">' . $Article['promotion'] .'€</td>
						 <td scope="row">' . $Article['image'] .'</td>
						 <td scope="row">'. $Article['add_date'] .'</td>
						 <td scope="row">' . $Article['add_admin'] .'</td>
						 <td scope="row">' . $Article['stripe'] .'</td>
						 <form action="../includes/modif-element.php?element=Article" method="post">
						  ...
						  <td scope="row">
						  <form action="delete.php?table=Article&id='.$Article['id'].'" method="post">
